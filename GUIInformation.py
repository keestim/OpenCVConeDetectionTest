...
class GUIInformation:
    ...
    def __onLowHThreshTrackbar(self, val):
        self.fHSV_processor_thread.setLowH(val)
        self.fHSV_processor_thread.low_H = min(self.fHSV_processor_thread.getHighH() - 1,
    ...
    def __onHighHThreshTrackbar(self, val):
        self.fHSV_processor_thread.setHighH(val)
        self.fHSV_processor_thread.high_H = max(self.fHSV_processor_thread.getHighH(), 
                                                self.fHSV_processor_thread.getLowH() + 1)
    ...
    def __onLowSThreshTrackbar(self, val):
        self.fHSV_processor_thread.setLowS(val)
        self.fHSV_processor_thread.low_S = min(self.fHSV_processor_thread.getHighS() - 1, 
    ...
    def __onHighSThreshTrackbar(self, val):
        self.fHSV_processor_thread.setHighS(val)
        self.fHSV_processor_thread.high_S = max(self.fHSV_processor_thread.getHighS(), 
                                                self.fHSV_processor_thread.getLowS() + 1)
    ...
    def __onLowVThreshTrackbar(self, val):
        self.fHSV_processor_thread.setLowV(val)
        self.fHSV_processor_thread.low_V = min(
                                                self.fHSV_processor_thread.getHighV() - 1, 
    ...
    def __onHighVThreshTrackbar(self, val):
        self.fHSV_processor_thread.setHighV(val)
        self.fHSV_processor_thread.high_V = max(self.fHSV_processor_thread.getHighV(), 
                                                self.fHSV_processor_thread.getLowV() + 1)
